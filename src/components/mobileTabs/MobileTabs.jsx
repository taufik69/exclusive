  ...
  return (
    <div>
      <div className="hidden sm:block">
        <div class="border-b  border-gray-200 dark:border-gray-700 rounded-full  bg-white/20 backdrop-blur-md bg-gray-300 shadow-xl flex items-center justify-center">
      ...
      <div className="border  sm:hidden border-gray-200 dark:border-gray-700 rounded-full bg-white/20 backdrop-blur-md shadow-xl flex items-center justify-center p-2">
        <ul className="flex flex-wrap text-sm font-medium text-gray-500 dark:text-gray-400">
          <li className="me-2">
            <Link
              to="/"
              className="inline-flex items-center justify-center p-3 hover:text-gray-600 dark:hover:text-gray-300 group"
            >
              <svg
          ...
          <li className="me-2">
            <Link
              to="/about"
              className="inline-flex items-center justify-center p-3 text-blue-600 dark:text-blue-500 group"
            >
              <svg
          ...
          {/* Repeat for Settings, Contacts, etc. */}
        </ul>
      </div>
    </div>
  );
